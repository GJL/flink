...
class DeploymentHandle {
	...
	DeploymentHandle(final ExecutionVertexVersion executionVertexVersion, final ExecutionVertexDeploymentOption deploymentOption, final SlotExecutionVertexAssignment slotExecutionVertexAssignment) {
		this.executionVertexVersion = executionVertexVersion;
		this.deploymentOption = deploymentOption;
		this.slotExecutionVertexAssignment = slotExecutionVertexAssignment;
	}
