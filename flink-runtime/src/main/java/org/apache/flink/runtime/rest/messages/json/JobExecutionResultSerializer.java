...
/**
 * JSON serializer for {@link JobExecutionResult}.
 *
 * @see JobExecutionResultDeserializer
 */
public class JobExecutionResultSerializer extends StdSerializer<JobExecutionResult> {
	...
	public JobExecutionResultSerializer() {
