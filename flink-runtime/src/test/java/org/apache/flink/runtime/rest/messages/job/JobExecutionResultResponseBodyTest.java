...
public class JobExecutionResultResponseBodyTest
	...
	public static Collection<Object[]> data() throws IOException {
		return Arrays.asList(new Object[][] {
			{JobExecutionResultResponseBody.created(JobExecutionResult.from(new org.apache.flink.runtime.jobmaster.JobExecutionResult.Builder()
				.jobId(TEST_JOB_ID)
	...
	protected void assertOriginalEqualsToUnmarshalled(
		...
		if (expectedJobExecutionResult != null) {
			...
			final SerializedThrowable expectedFailureCause = expectedJobExecutionResult.getFailureCause();
			if (expectedFailureCause != null) {
				final SerializedThrowable actualFailureCause = actualJobExecutionResult.getFailureCause();
				assertNotNull(actualFailureCause);
