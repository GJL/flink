...
import org.apache.flink.streaming.connectors.fs2.AvroKeyValueSinkWriter;
import org.apache.flink.streaming.connectors.fs2.SequenceFileWriter;
...
public class BucketingSinkTest {
	...
	public static void createHDFS() throws Exception {
		...
		dfs = FileSystem.get(new URI(hdfsURI));
	}
	...
	public void testNonRollingSequenceFileWithoutCompressionWriter() throws Exception {
		...
		SequenceFile.Reader reader = new SequenceFile.Reader(new org.apache.hadoop.fs.FSDataInputStream(inStream), 1000, 0, 100000, new Configuration());
	...
	public void testDateTimeRollingStringWriter() throws Exception {
		...
		FileStatus[] files = dfs.listStatus(new Path(outPath)); //TODO: make recursive
